        ...
        <div class="home-content">
            <div class="sales-boxes">
                <div class="recent-sales box">
                    ...
                    <br>
                    <?php if (!isset($courses['id_course'])) {
                            ...
                            <div class="cart-pre">
                                ...
                                <div class="cart-details">
                                    ...
                                    <p id="number-course">
                                        ...
                                        Số lượng bài học:
                                        <?php echo $courses['number_course'] ?>
                                    </p>
                                    ...
                                    <p id="price-course">
                                        ...
                                        Giá thành:
                                        <?php echo currency_format($courses['price']) ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="recent-sales box">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="tooltip">Xem
                                    <span class="tooltiptext">
                                        <?php echo $ls['description_lesson'] ?>
                                    </span>
                                </div>
                            </th>
                            <th>
                                <p id="lesson<?php echo $ls['id_lesson'] ?>" style="display:none;">
                                    <?php echo $ls['description_lesson'] ?></p>
                                <a href="#trang-trang"
                            ...
                            <th>
                                <a
                                    href="./processing/course_delete_lesson.php?id=<?php echo $ls['id_lesson'] ?>&id_course=<?php echo $ls['id_course'] ?>">Xóa</a>
                            </th>
                        </tr>
                        <?php } ?>
                    </table>
            ...
            <div class="sales-boxes" style="margin-top: 26px">
                <div class="recent-sales box">
                    ...
                    <div>
                        ...
                        <?php for ($i = 1; $i <= $so_luong_trang; $i++) { ?>
                        <?php if ($i == $trang) { ?>
                        <a class="page" style="border: 1px solid #0a2558;" href="#">
                            <?php echo $i ?>
                        </a>
                        <?php } else { ?>
                        <a class="page" href="#">
