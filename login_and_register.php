                            ...
                            <form id="login-form" method="POST" action="./processing/login.php">
                                <div class="input-boxes">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input id="email-login" name="email_user" type="email" placeholder="Email"
                                            required>
                                    </div>
                                    ...
                                    <div class="text sign-up-text">Bạn không có tài khoản? <label for="flip">Đăng
                                            kí</label></div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="signup-form">
                            ...
                            <form id="form-register" method="POST" action="./processing/register.php">
                                <div class="input-boxes">
                                    ...
                                    <div class="input-box">
                                        <i class='bx bx-mail-send'></i>
                                        <input id="email-register" name="email_user" type="email" placeholder="Email"
                                            required>
                                    </div>

                                    <div class="input-box">
                                        <i class='bx bx-phone'></i>
                                        <input id="phone-number-register" name="phone_number_user" type="text"
                                    ...
                                    <div class="text sign-up-text">Bạn đã có tài khoản? <label for="flip">Đăng
                                            nhập</label></div>
                                </div>
                            </form>
                        </div>
